...
Un problema que debe solucionar el LicitaSoft es la generación de todas las posibles Combinaciones de Ofertas y la determinación de la Combinación ganadora. Ahora, el software no solo se programó para eso, sino que también posee cierta inteligencia para determinar el grado de riesgo de las Combinaciones y descartar las de riego más alto. Para eso se definieron criterios de selección que deben cumplir las Entidades participantes. Dichos criterios se detallan a continuación:
  - Para adjudicarle _n_ Lotes a una Entidad, ésta debe contar con al menos _n+1_ contratos concretados anteriormente.
  - Para adjudicarle _n_ Lotes a una Entidad, ésta debe contar con una [experiencia](#experiencia) mayor o igual a la [experiencia requerida](#experiencia-requerida) por los Lotes. 
  - Para adjudicarle _n_ Lotes a una Entidad, ésta debe
    - si es una Empresa, contar con [recursos financieros](#recursos-financieros) mayores o iguales a los [recursos financieros requeridos](#recursos-financieros-requeridos) por los lotes.
  ...
  - Para adjudicarle _n_ Lotes a una Entidad, ésta debe
    - si es una Empresa, contar con una [facturación media anual](#facturación-media-anual) mayor o igual a la [facturación media anual requerida](#facturación-media-anual-requerida) por los lotes.
    - si es una Asociación, contar con una [facturación media anual](#facturación-media-anual) mayor o igual a la [facturación media anual requerida](#facturación-media-anual-requerida) por los lotes. Además, cada Socio debe contar con, al menos, el 20% de la [facturación media anual requerida](#facturación-media-anual-requerida) por los Lotes, pudiendo sólo un Socio no cumplir con este criterio pero debiendo cumplir con, al menos, el 15% de la misma. Y por lo menos un Socio debe contar con, al menos, el 40% de la [facturación media anual](#facturación-media-anual-requerida) por los Lotes.
