...
class DialogoLote(QDialog):
    ...
    def dibujar_IU(self):
        ...
        grilla.addWidget(QLabel("Facturación Media Anual requerida"), 2, 0)
        ...
        grilla.addWidget(QLabel("Recursos Financieros requeridos"), 3, 0)
        ...
        grilla.addWidget(QLabel("Experiencia requerida"), 4, 0)
